class Bake < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/myferr/bake/releases/download/v0.1.2/bake-macos-x86_64"
      sha256 "14ed6e706c8ddfb3a20c0f1e9daef1bee5f72ae69381e21ed5e8989d65356aa8"
    elsif Hardware::CPU.arm?
      url "https://github.com/myferr/bake/releases/download/v0.1.2/bake-macos-aarch64"
      sha256 "91ee54ba507d69257c2d23ec3e75bb5407b59bf11a9d48d00ec260e87aca4c10"
    end
  end

  on_linux do
    url "https://github.com/myferr/bake/releases/download/v0.1.2/bake-linux-x86_64"
